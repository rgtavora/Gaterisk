<h3><img src="lib/iconza/asterisk_32x32.png" style="vertical-align:sub;"/> Ramais SIP</h3>
<table id="arc-table">
	<tr>
		<td colspan="5">
			<div align="center">
	...
	<tr>
		...
		<td style="text-align:center;">
			<a href="?p=sip_edt&amp;username=<?php echo $ramal["username"]; ?>">
				<img src="lib/iconza/edit_32x32.png">
			</a>
		</td>
		<td style="text-align:center;">
			<a href="?p=sip_rem&amp;username=<?php echo $ramal["username"]; ?>">
